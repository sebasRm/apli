...
public class AdaptadorListaPlatosMenu extends  RecyclerView.Adapter<AdaptadorListaPlatosMenu.ViewHolder> implements View.OnClickListener
{
    ...
    {
        View view = inflater.from(parent.getContext()).inflate(R.layout.fragment_lista_platos, null);
    ...
    {
        holder.constraintLayout.setAnimation(AnimationUtils.loadAnimation(contexto, R.anim.fade_transition));
        try
        {
