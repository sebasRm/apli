...
public class AdaptadorListaPlatos extends  RecyclerView.Adapter<AdaptadorListaPlatos.ViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        holder.cardViewPlatosMesnu.setAnimation(AnimationUtils.loadAnimation(contexto, R.anim.fade_transition));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(@NonNull View itemView)
        {
            ...
            cardViewPlatosMesnu=(CardView) itemView.findViewById (R.id.cardViewPlatosMesnu);
        }
    }
